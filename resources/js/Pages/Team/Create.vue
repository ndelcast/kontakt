...
<template>
    <div class="max-w-xl">
        <div class="flex items-center gap-3 mb-6">
            ...
            <h1 class="text-2xl font-bold text-surface-900 dark:text-surface-0">Nouvelle équipe</h1>
        </div>
            ...
            <template #content>
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div class="flex justify-end gap-3 pt-4">
                        <Link href="/app"><Button label="Annuler" severity="secondary" outlined /></Link>
