...
<template>
    <div class="max-w-2xl">
        <div class="flex items-center gap-3 mb-6">
            ...
            <h1 class="text-2xl font-bold text-surface-900 dark:text-surface-0">Modifier la tâche</h1>
        </div>
        ...
        <Card>
            <template #content>
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div v-if="form.completed_at" class="border-t pt-4 mt-4">
                        <h3 class="text-sm font-semibold mb-3">Complétion</h3>
                        <div>
                            <label class="block text-sm font-medium mb-1">Résultat</label>
