...
const props = defineProps({ contact: Object, companies: Array });

const form = useForm({ ...props.contact });

const submit = () => form.put(`/app/contacts/${props.contact.id}`);
</script>
...
<template>
    <div class="max-w-2xl">
        <div class="flex items-center gap-3 mb-6">
            ...
            <h1 class="text-2xl font-bold text-surface-900 dark:text-surface-0">Modifier le contact</h1>
        </div>
